 ...
 * 			조건식1이 참인 경우 실행문;
 * 		}else if(조건식2){
 * 			조건식 1은 거짓이고, 조건식2는 참인 경우 실행문; 
 * 
 * 		}else if(조건식3){
 * 			조건식 1은 거짓이고, 조건식2가 거짓이고 조건식 3은 참인 경우 실행문;
 * 		}else{
 * 			조건식, 조건식2, 조건식3 모두가 거짓인 경우 실행문;
 * }
 * 
 */
...
public class ifElseIfExam_12 {
	...
	public static void main(String[] args) {
		...
		if (num == 1) {
			...
			System.out.println("입력받은 숫자는 1~3 이외의 숫자 입니다.");
